...
const CACHE = 'ironbound-v34';
const ASSETS = ['./', './index.html', './app-backend.js', './manifest.webmanifest', './icon.svg', './assets/rat-warrens-cover-v3.png', './assets/forest-background.png',
