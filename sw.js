...
const CACHE = 'ironbound-v17';
const ASSETS = ['./', './index.html', './app-backend.js', './manifest.webmanifest', './icon.svg', './assets/rat-warrens-cover.png', './assets/forest-background.png', './assets/item-pedestal.png',
